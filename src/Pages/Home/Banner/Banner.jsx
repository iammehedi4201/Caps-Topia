...
const Banner = () => {
  return (
    <div  data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="200"  className="relative  flex justify-around  bg-white pt-[120px] mt-[100px] pb-[16px] lg:pt-[160px] lg:mt-[100px] ">
      <div className="container mx-auto">
        <div className="flex flex-wrap -mx-4">
          <div className="w-full px-4 lg:w-5/12">
            <div className="hero-content flex flex-col">
              <h1 className="mb-3 text-4xl font-bold leading-snug text-black sm:text-[42px] lg:text-[40px] xl:text-[42px]">
              ...
              <div className="pt-16 clients w-full">
                ...
                <div className="flex items-center flex-wrap space-x-4 space-y-4 sm:space-y-0">
                  <img
            ...
            <div className="lg:ml-auto lg:text-right">
              <div className="relative  z-10  pt-11 lg:pt-0">
                <img
                  src={profileImg}
                  alt="hero"
                  className="max-w-sm mx-auto lg:ml-auto w-full"
                />
              </div>
            </div>
          </div>
