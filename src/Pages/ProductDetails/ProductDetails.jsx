...
import imgTwo from "./walpaperjpg.jpg";
...
const ProductDetails = () => {
  ...
  return (
    <div className="pt-20">
      ...
      {/* <!-- component --> */}
      <section className="min-h-screen flex items-center text-gray-700 body-font overflow-hidden bg-white p-5 shadow-xl">
        <div className="container px-5 py-24 mx-auto border-2 border-emerald-900 rounded-lg ">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <img
              alt="ecommerce"
              className="lg:max-w-xs w-1/2 object-cover object-center mx-auto rounded  ring-2 ring-red-500 ring-offset-8"
              src={img}
            />
