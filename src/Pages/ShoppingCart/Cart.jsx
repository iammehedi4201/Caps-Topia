          ...
          <div className="card-body">
            ...
            <div className="card-actions justify-center text-2xl font-medium">
              <h1 className="text-sm  sm:text-2xl font-medium underline underline-offset-4 ">
                <span className="text-orange">Cart</span> Page
              </h1>
            </div>
          </div>
        </div>
      </section>
      <div className=" bg-gray-100 pt-20 p-10 rounded-md mt-12">
              ...
              <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                ...
                <div className="mt-4 flex justify-between sm:space-y-6 sm:mt-0 sm:block sm:space-x-6">
                  <div className="flex items-center border-gray-300">
                    <span className="cursor-pointer text-black rounded-l bg-gray-100 py-1 px-3.5 duration-100 hover:bg-blue-500 hover:text-blue-50">
                      {" "}
                      -{" "}
                    </span>
                    <input
                      ...
                      min="1"
                    />
                    <span className="cursor-pointer text-black rounded-r bg-gray-100 py-1 px-3 duration-100 hover:bg-blue-500 hover:text-blue-50">
                      {" "}
                      +{" "}
                    </span>
                  </div>
