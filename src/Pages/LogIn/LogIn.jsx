  ...
  return (
    <div>
      <section className="min-h-screen flex items-center">
        <div className="container h-full px-6 py-24 shadow-lg ">
            ...
            <div className="w-10/12 md:w-8/12 lg:ml-6 lg:w-5/12 p-5 bg-slate-900 rounded-xl text-white">
              <form onSubmit={handleLogIn}>
                ...
                <div className="my-6 flex items-center justify-between">
                  ...
                  <a
                    href="#!"
                    className="text-white underline transition duration-150 ease-in-out hover:text-red-600 focus:text-primary-600 active:text-primary-700 dark:text-primary-400 dark:hover:text-primary-500 dark:focus:text-primary-500 dark:active:text-primary-600"
                  >
                    Forgot password?
                  </a>
                </div>
